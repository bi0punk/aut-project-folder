...
def menu():
    ...
    print("\t#")
    print("\t#")
    print("\t#" + bcolors.WARNING  + "   1.- " + bcolors.ENDC +  "Simple Python Script")
    print("\t#" + bcolors.WARNING  + "   2.- " + bcolors.ENDC +  "Simple Empty Flask Application")
    print("\t#" + bcolors.WARNING  + "   3.- " + bcolors.ENDC +  "Simple Empty Flask Application with Virtual Environment (venv)")
    print("\t#" + bcolors.WARNING  + "   4.- " + bcolors.ENDC +  "Flask Aplication with V/e + Bootstrap v4/v5")
